  ...
  <nav :style="{ 'margin-left': drawer ? '230px' : '0' }">
    <v-toolbar id="toolbar" class="toolbar" flat style="height: 75px;">
      ...
      <v-toolbar-title id="title" class="text-uppercase">
        <P v-if="$vuetify.breakpoint.smAndUp" color="grey" style="margin-left: 10px;"><h1>MAEDOTAID CHARITY ORGANIZATION</h1> </p>
        <P v-if="$vuetify.breakpoint.xs" style="font-size: 14px;" color="grey">MAEDOTAID <br> CHARITY ORGANIZATION</p>
      </v-toolbar-title>
      <v-spacer></v-spacer>
